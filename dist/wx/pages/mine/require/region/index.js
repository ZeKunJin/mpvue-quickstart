...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_20471c8d_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(292);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_20471c8d_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/pages/mine/require/region/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-20471c8d", Component.options)
  } else {
    hotAPI.reload("data-v-20471c8d", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_assign__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__api_region__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__utils_bus__ = __webpack_require__(39);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  onLoad: function onLoad(option) {
    __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_assign___default()(this, this.$options.data());
  ...
  onShow: function onShow() {
    ...
    __WEBPACK_IMPORTED_MODULE_7__utils_bus__["a" /* default */].$on('refresh', function (res) {
  ...
  methods: {
    ...
    getRegionText: function getRegionText() {
      var _this3 = this;
      ...
      return __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_asyncToGenerator___default()( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_2_babel_runtime_regenerator___default.a.mark(function _callee2() {
        var _requirement, province, city, area, street, village, regionArr, res;

        return __WEBPACK_IMPORTED_MODULE_2_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _requirement = _this3.requirement, province = _requirement.province, city = _requirement.city, area = _requirement.area, street = _requirement.street, village = _requirement.village;
                regionArr = [province, city, area, street, village];
                _context2.next = 4;
                return Object(__WEBPACK_IMPORTED_MODULE_6__api_region__["b" /* regionText */])({
                  info: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify___default()(regionArr)
                });

              case 4:
                res = _context2.sent;

                _this3.regionText = res.data[res.data.length - 1];
    ...
    getProvince: function getProvince() {
      ...
      return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function () {
        var _ref = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_asyncToGenerator___default()( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_2_babel_runtime_regenerator___default.a.mark(function _callee3(resolve) {
          var res;
          return __WEBPACK_IMPORTED_MODULE_2_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  _context3.next = 2;
                  return Object(__WEBPACK_IMPORTED_MODULE_6__api_region__["a" /* regionInfo */])({
                    code: _this4.requirement.area,
                    type: 3
                  });
                ...
                case 2:
                  ...
                  _this4.formatProvince(res.data);
    ...
    getVillage: function getVillage(code) {
      ...
      return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function () {
        var _ref2 = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_asyncToGenerator___default()( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_2_babel_runtime_regenerator___default.a.mark(function _callee4(resolve) {
          var res;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 3;
                return _this8.getVillage(value[0].value);

              case 3:
                picker.setColumnValues(1, _this8.villageList);
    ...
    validate: function validate() {
      ...
      return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
        var info = _this9.requirement.longitude && _this9.requirement.dimension && _this9.requirement.street && _this9.requirement.village && _this9.requirement.area;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.prev = 0;
                _context6.next = 3;
                return _this10.validate();

              case 3:
                _context6.prev = 3;

                _this10.requirement.city = String(_this10.requirement.area).slice(0, 4);
                _this10.requirement.province = String(_this10.requirement.area).slice(0, 2);
                _context6.next = 8;
                return Object(__WEBPACK_IMPORTED_MODULE_5__api_require__["c" /* editRequirement */])(_this10.requirement);

              case 8:
                _this10.$navigate.to("/pages/require/index");
                wx.showToast({
                  title: "修改成功",
                  icon: "none"
                });
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("确认修改")])])], 1)], 1)], 1), _vm._v(" "), _c('van-dialog', {
    attrs: {
      "use-slot": "",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-20471c8d", esExports)
  }
}
