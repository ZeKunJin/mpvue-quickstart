...
Component.options.__file = "src/pages/require/comment/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-46aad268", Component.options)
  } else {
    hotAPI.reload("data-v-46aad268", Component.options)
  }
